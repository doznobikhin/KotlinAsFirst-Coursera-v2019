...
//    println("Result: $result")
    //println("3801".substring(1,2))
//    println(1e-2 * 100) //1e-2 = 1 / 10^-2   1/100
    val number: Int = 7
...
//(number.toString().substring(number.toString().length - 3, number.toString().length - 2).toInt())
...
fun numberRevert(number: Int): Int =
    (number + ((number - number / 10 * 10) - number / 100) * 99)
